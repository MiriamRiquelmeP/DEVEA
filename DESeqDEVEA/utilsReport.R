...
geneIdConverter <- function(genes, specie="Mm"){
...
geneIdConverterOld <- function(genes, specie="Mm"){ # genes = vector of ensembl gene ids (sólo para Mm por ahora)
  require("EnsDb.Mmusculus.v79")
  require("org.Mm.eg.db")
  require("EnsDb.Hsapiens.v86")
  require("org.Hs.eg.db")
  ...
  if(specie=="Mm"){
      ...
      #ensdb <- ensembldb::EnsDb("/devea-main/DESeqDEVEA/resources/At/EnsDb.Athaliana.v94.sqlite")
      ensdb <- ensembldb::EnsDb("./resources/At/EnsDb.Athaliana.v94.sqlite")
      orgdb <- org.At.tair.db
  }
  annot <- NULL
...
gseaKeggReport <- function(res, specie, gseadb){
